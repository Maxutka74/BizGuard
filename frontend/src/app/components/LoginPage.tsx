        ...
        >
            ...
            <div className="relative z-10 w-full max-w-md px-6">
                ...
                <div className="flex flex-col items-center mb-10">
                    ...
                    >
                        АНАЛІТИКА ЗАГРОЗ ЕЛЕКТРОННОЇ ПОШТИ
                    </p>
                </div>
                ...
                >
                    ...
                    <p className="mb-8" style={{ color: "var(--muted-foreground)", fontSize: "0.875rem" }}>
                        Підключіть свій акаунт Gmail для сканування на фішингові загрози
                    </p>
                    ...
                    <div className="space-y-3 mb-8">
                        {[
                            { icon: Mail, text: "Автоматичне сканування останніх 50 листів" },
                            { icon: Eye, text: "Виявлення фішингу на базі ШІ" },
                            { icon: Lock, text: "Аналіз репутації та схожості доменів" },
                        ].map(({ icon: Icon, text }) => (
                  ...
                  {text}
                    ...
                    >
                        Ми запитуємо лише доступ для читання вашого Gmail. Ваші дані ніколи не зберігаються.
                    </p>
                </div>
            </div>
        </div>
